...
class TkinterTester(BaseGUITester):
    ...
    def __init__(self, app_name: str):
        ...
        if not TKINTER_AVAILABLE:
            raise ImportError("tkinter not available. Install tkinter to test tkinter GUIs.")
...
class DashTester(BaseGUITester):
    ...
    def __init__(self, app_name: str):
        ...
        if not DASH_AVAILABLE:
            raise ImportError("Dash not available. Install dash[testing] to test Dash GUIs.")
    ...
    def wait_for_element(self, selector: str, timeout: int = 10, by: str = "css_selector") -> bool:
