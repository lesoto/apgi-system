...
class ValidationError(APGIError):
    ...
    def __init__(self, message: str, data_field: Optional[str] = None, **kwargs: Any) -> None:
        if data_field:
...
class ProtocolError(APGIError):
    ...
    def __init__(self, message: str, protocol_name: Optional[str] = None, **kwargs: Any) -> None:
        if protocol_name:
...
class DataError(APGIError):
    ...
    def __init__(self, message: str, data_source: Optional[str] = None, **kwargs: Any) -> None:
        if data_source:
...
class ImportWarning(APGIError):
    ...
    def __init__(self, message: str, package: Optional[str] = None, **kwargs: Any) -> None:
        if package:
...
class ErrorHandler:
    ...
    def get_error_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "error_distribution": {cat.value: count for cat, count in self.error_counts.items()},
        }
