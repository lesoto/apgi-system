...
class DataValidator:
    ...
    def __init__(self, strict_mode: bool = False, config: Optional[ValidationConfig] = None):
    ...
    def _validate_csv_structure(self, df: pd.DataFrame, results: Dict[str, Any]) -> bool:
    ...
    def _validate_hdf5_structure(self, df: pd.DataFrame, results: Dict[str, Any]) -> bool:
