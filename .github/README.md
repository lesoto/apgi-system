...
```bash
# Format check
black --check apgi_framework tests

# Auto-format
black apgi_framework tests

# Linting
flake8 apgi_framework tests

# Type checking
mypy apgi_framework --ignore-missing-imports

# Run tests with coverage
pytest tests/ -v --cov=apgi_framework --cov-report=html --cov-report=term-missing
```
