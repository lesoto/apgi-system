...
class APGIGui:
    ...
    def _update_neural_plots(self, time_data: Any, data_copies: Dict[str, Any]) -> None:
        ...
        self.neural_canvas.draw_idle()  # type: ignore[attr-defined]
    ...
    def _update_state_space(self, time_data: Any, data_copies: Dict[str, Any]) -> None:
        ...
        self.state_canvas.draw_idle()  # type: ignore[attr-defined]
    ...
    def _toggle_neural_activity(self) -> None:
        ...
        if visible:
            # Show tab
            if self.tab_frames[tab_index] not in self.notebook.tabs():  # type: ignore[attr-defined]
