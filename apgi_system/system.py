...
class APGISystem:
    ...
    def _initialize_subsystems(self) -> None:
        ...
        for name, subsystem in self._subsystem_protocol_adapters.items():
            assert isinstance(subsystem, SubsystemProtocol), (
    ...
    def step(
        ...
        available_actions = [self._rng.normal(size=10) for _ in range(self.active_inference.num_policies)]
        ...
        if ignition_occurred and float(self._rng.random()) < 0.1:
