...
class APGISystem:
    ...
    def step(
        ...
        # 13. Entropy tracking
        entropy_info = self.entropy.update(
            num_spikes=0,
            ignition=ignition_occurred,
            dt=dt
        )
        ...
        # Record history
        self._record_history(ignition_occurred, ai_info['free_energy'],
                            precision_info, metabolic_info)
    ...
    def run(
        ...
        extero_input_fn: Optional[callable] = None
    ) -> Dict[str, Any]:
        """
