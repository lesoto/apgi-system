...
class VP15ValidationProtocol:
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        self.bounds = VP15Bounds(
            critical_energy=raw.get("critical_energy", b.critical_energy),
            energy_restore_rate=raw.get("energy_restore_rate", b.energy_restore_rate),
            max_allostatic_load=raw.get("max_allostatic_load", b.max_allostatic_load),
            load_damping_gain=raw.get("load_damping_gain", b.load_damping_gain),
            kl_epsilon=raw.get("kl_epsilon", b.kl_epsilon),
            min_synchrony=raw.get("min_synchrony", b.min_synchrony),
            precision_floor=raw.get("precision_floor", b.precision_floor),
            precision_ceil=raw.get("precision_ceil", b.precision_ceil),
        )
