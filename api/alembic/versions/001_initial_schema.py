...
def upgrade() -> None:
    ...
    op.create_table(
        'users',
        sa.Column('user_id', sa.String(length=36), nullable=False, comment='Unique user identifier'),
        ...
        sa.Column('roles', postgresql.ARRAY(sa.Text()), nullable=False, comment='User roles for RBAC'),
    ...
    op.create_table(
        'sessions',
        sa.Column('session_id', sa.String(length=36), nullable=False, comment='Unique session identifier'),
        sa.Column('user_id', sa.String(length=36), nullable=False, comment='Owner user ID'),
        sa.Column('config', postgresql.JSONB(astext_type=sa.Text()), nullable=False, comment='Session configuration as JSON'),
        ...
        sa.Column('description', sa.Text(), nullable=True, comment='Human-readable session description'),
        sa.Column('tags', postgresql.ARRAY(sa.Text()), nullable=True, comment='Session tags for organization'),
    ...
    op.create_table(
        'tasks',
        sa.Column('task_id', sa.String(length=36), nullable=False, comment='Unique task identifier'),
        sa.Column('session_id', sa.String(length=36), nullable=False, comment='Associated session ID'),
        sa.Column('task_type', sa.String(length=50), nullable=False, comment='Type of experimental task'),
        sa.Column('parameters', postgresql.JSONB(astext_type=sa.Text()), nullable=False, comment='Task parameters as JSON'),
        ...
        sa.Column('result_data', postgresql.JSONB(astext_type=sa.Text()), nullable=True, comment='Task results as JSON'),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='Task creation timestamp'),
        ...
        sa.Column('webhook_url', sa.String(length=500), nullable=True, comment='Webhook URL for completion notification'),
    ...
    op.create_table(
        ...
        sa.Column('data', postgresql.JSONB(astext_type=sa.Text()), nullable=False, comment='State data as JSON'),
    ...
    op.create_table(
        'refresh_tokens',
        sa.Column('token_id', sa.String(length=36), nullable=False, comment='Unique token identifier'),
        sa.Column('user_id', sa.String(length=36), nullable=False, comment='Associated user ID'),
        sa.Column('token_hash', sa.String(length=255), nullable=False, comment='Hashed refresh token'),
        ...
        sa.Column('revoked', sa.Boolean(), nullable=False, comment='Whether token has been revoked'),
        sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], ondelete='CASCADE'),
    ...
    op.create_table(
        'webhook_deliveries',
        sa.Column('delivery_id', sa.String(length=36), nullable=False, comment='Unique delivery identifier'),
        ...
        sa.Column('payload', postgresql.JSONB(astext_type=sa.Text()), nullable=False, comment='Webhook payload as JSON'),
        ...
        sa.Column('last_attempt_at', sa.DateTime(timezone=True), nullable=True, comment='Last delivery attempt timestamp'),
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='Delivery record creation timestamp'),
