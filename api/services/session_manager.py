...
from api.database.models import Session as SessionModel, SessionState
from api.models.schemas import SessionCreateRequest, SessionStateEnum
...
class SessionManager:
    ...
    async def get_session(self, session_id: str) -> SimulationSession:
        ...
        if cached_data:
            ...
            sim_session.created_at = datetime.fromisoformat(metadata["created_at"].replace("Z", "+00:00"))
            sim_session.updated_at = datetime.fromisoformat(metadata["updated_at"].replace("Z", "+00:00"))
