...
class SystemAnalyzer:
    ...
    def compute_ignition_statistics(
        ...
        # Extract ignition times (recent_ignitions is a list of floats, not dicts)
        ignition_times = recent_ignitions
...
def analyze_simulation_run(system: Any) -> AnalysisResults:
    ...
    --------
    >>> from apgi_framework.system import APGISystem
    >>> from apgi_framework.analysis import analyze_simulation_run
    >>> system = APGISystem()
    >>> system.run(duration_ms=5000.0)
