...
class TestBodyModel:
    ...
    def test_update_basic_functionality(self, config):
        ...
        expected_keys = ['heart_rate', 'respiration', 'temperature', 'glucose', 'cortisol', 'blood_pressure']
    ...
    def test_activity_effects_on_multiple_variables(self, config):
        ...
        assert body_model.current_state.heart_rate > 90  # 70 + 50*0.9 = 115
        assert body_model.current_state.respiration > 20  # 15 + 10*0.9 = 24
        assert body_model.current_state.glucose < 4.5  # 5.0 - 1.0*0.9 = 4.1
    ...
    def test_stress_effects_on_cortisol(self, config):
        ...
        # Set high stress
        body_model.set_stress(0.7)
        
        # Update multiple times (cortisol has slow dynamics)
        for _ in range(50):
            body_model.update(dt=100.0)
        
        # Cortisol should be elevated from baseline (10 + 15*0.7 = 20.5)
        assert body_model.current_state.cortisol > 15
