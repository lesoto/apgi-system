...
class TestFreeEnergyCalculator:
    ...
    def test_complexity_term_computation(self) -> None:
        ...
        fe, components = calc.compute_variational_free_energy(
            observation, prediction, precision, mean, cov, mean, cov  # Same posterior  # and prior
        )
    ...
    def test_precision_matrix_formats(self) -> None:
        ...
        fe1, _ = calc.compute_variational_free_energy(
            observation, prediction, 2.0, posterior_mean, posterior_cov, prior_mean, prior_cov
        )
