...
class TestInstallerScript:
    ...
    @pytest.fixture
    def installer_script_path(self):
        """Get path to the installer script."""
        return Path("build/installer_windows.iss")

    @pytest.fixture
    def installer_script_content(self, installer_script_path):
    ...
    def test_installer_script_exists(self, installer_script_path):
    ...
    def test_has_setup_section(self, installer_script_content):
        """Test that script has [Setup] section."""
        assert "[Setup]" in installer_script_content

    def test_has_app_identification(self, installer_script_content):
    ...
    def test_has_installation_directory_config(self, installer_script_content):
    ...
    def test_has_start_menu_config(self, installer_script_content):
    ...
    def test_has_icons_section(self, installer_script_content):
    ...
    def test_has_desktop_shortcut_option(self, installer_script_content):
    ...
    def test_has_uninstaller_config(self, installer_script_content):
    ...
    def test_references_executable(self, installer_script_content):
    ...
    def test_references_icon_file(self, installer_script_content):
        """Test that script references icon file."""
        assert ".ico" in installer_script_content or "SetupIconFile=" in installer_script_content

    def test_output_directory_configured(self, installer_script_content):
    ...
    def test_wizard_style_configured(self, installer_script_content):
    ...
    def test_no_syntax_errors_in_sections(self, installer_script_content):
    ...
    def test_includes_config_files(self, installer_script_content):
    ...
    def test_includes_resources(self, installer_script_content):
...
class TestInstallerUtilsIntegration:
    ...
    def test_version_extraction_works(self):
        """Test that version can be extracted from pyproject.toml."""
        from build.installer_utils import extract_version_from_pyproject
